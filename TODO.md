...
- [ ] **#4** Rename `list` parameter in `SubListExpr.__init__` to avoid shadowing the built-in (line 448) — rename to `list_expr` to match the convention already used in `IndexExpr`.

- [ ] **#5** Fix typo `"fof"` → `"for"` in comment (line 1177).
